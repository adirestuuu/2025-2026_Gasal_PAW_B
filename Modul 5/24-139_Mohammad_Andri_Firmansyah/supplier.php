    ...
    <div class="tabel">
        <table>
            ...
            <tr>
                ...
                <td>
                    <div class="tombol">
                        <button class="btn btn-edit" onclick="window.location.href='editsupplier.php'">Edit</button>
                        <button class="btn btn-hapus" onclick="return confirm('Anda yakin ingin menghapus supplier ini?')">Hapus</button>
                    </div>
                </td>
            </tr>
            <?php endwhile; ?>
